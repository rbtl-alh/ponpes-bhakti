...
class ImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kategori_id = $request->all();
        $folder = 'assets/images';
        $itemgambar = $this->upload($fileupload, $itemuser, $kategori_id, $folder);
        // $inputan = $request->all();
    ...
    public function upload($fileupload, $itemuser, $kategori_id, $folder) {
        $path = $fileupload->store('public/files');    
        $inputangambar['url'] = $path;
        $inputangambar['kategori_id'] = $kategori_id['kategori_id'];
